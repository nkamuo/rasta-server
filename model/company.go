...
type Company struct {
	...
	OperatorUser   *User      `gorm:"foreignKey:OperatorUserID;references:ID;constraint:OnUpdate:CASCADE,OnDelete:SET NULL;" json:"user"` // BelongsToMany Association - These mappings may be optional
