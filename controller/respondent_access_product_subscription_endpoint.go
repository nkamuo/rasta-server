...
func FindRespondentSubscriptionPrices(c *gin.Context) {
	...
	Query := fmt.Sprintf("active:'true' AND product: \"%s\"", config.STRIPE_RESPONDENT_SUBSCRIPTION_PRODUCT_ID)
	params := &stripe.PriceSearchParams{
...
func CreateRespondentSubscriptionCheckoutSession(c *gin.Context) {

	var input dto.RespondentSubscriptionSessionCheckoutInput
